...
<html lang="en">
    <head>
        ...
        <title>RMS Admin Manage Students</title>
...
echo htmlentities('Active');
   ...
   echo htmlentities('Blocked'); 
                                                                ...
                                                                ?></td>
<td>
<a href="edit-student.php?stid=<?php echo htmlentities($result->StudentId);?>"><i class="fa fa-edit" title="Edit Record" style="color: blue;"></i> </a> 
