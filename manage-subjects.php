...
<html lang="en">
    <head>
        ...
        <title>RMS Admin Manage Subjects</title>
...
<td>
<a href="edit-subject.php?subjectid=<?php echo htmlentities($result->id);?>"><i class="fa fa-edit" title="Edit Record" style="color: blue;"></i></a >  
